...
def check_configuration(
    ...
    for hp_name in space.dag.nodes:
...
def change_hp_value(
    ...
    children = configuration_space.get_children_of(hp_name)
    if len(children) > 0:
        ...
        while len(to_visit) > 0:
            ...
            conditions = configuration_space.get_parent_conditions_of(current_name)
            ...
            if active:
                ...
                if current_value == current_value:
                    children_ = configuration_space.get_children_of(current_name)
                    if len(children_) > 0:
            ...
            if not active and current_value == current_value:
                ...
                children = configuration_space.get_children_of(current_name)
                ...
                if len(children) > 0:
                    ...
                    while len(to_disable) > 0:
                        ...
                        children = configuration_space.get_children_of(child)
